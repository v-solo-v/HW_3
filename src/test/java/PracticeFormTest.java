...
public class PracticeFormTest {
    ...
    void automationPracticeForm () {
        ...
        $("#subjectsInput").setValue("Argentinas").pressEnter();
        $("#hobbies-checkbox-3").parent().$(byText("Sports")).click();
        ...
        $(".modal-body").shouldHave(text("30 October,1960"));
        $(".modal-body").shouldHave(text("Argentinas"));
